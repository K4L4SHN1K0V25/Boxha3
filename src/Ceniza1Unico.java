...
public class Ceniza1Unico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Peso constante (gramos)");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Peso final (gramos)");

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Muestra (gramos)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        P1 = Double.parseDouble(DA.getText());
        P2 = Double.parseDouble(DB.getText());
        G = Double.parseDouble(DW.getText());
